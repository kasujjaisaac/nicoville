    ...
    <div class="admin-layout">
        <aside class="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <a class="sidebar-link" href="/admin/contact-messages"><span class="sidebar-icon">02</span><span>Messages</span></a>
                <a class="sidebar-link active" href="/admin/donations"><span class="sidebar-icon">03</span><span>Donations</span></a>
            ...
            <div class="items">
                @forelse ($donations as $donation)
                    <article class="item-card">
                        ...
                        <form class="actions" method="POST" action="/admin/donations/{{ $donation->id }}">
                            @csrf @method('PATCH')
                            <select name="status"><option value="pending" @selected($donation->status === 'pending')>Pending</option><option value="confirmed" @selected($donation->status === 'confirmed')>Confirmed</option><option value="cancelled" @selected($donation->status === 'cancelled')>Cancelled</option></select>
                            <button class="save-button" type="submit">Update</button>
                        </form>
                    </article>
                @empty
                    <div class="notice">No donations have been submitted yet.</div>
                @endforelse
            </div>
